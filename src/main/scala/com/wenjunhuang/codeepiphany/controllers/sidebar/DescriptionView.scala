...
import com.wenjunhuang.codeepiphany.utils.{Log, intellijIORuntime}
import fs2.Stream
...
class DescriptionView(private val project: Project, private val presenter: DescriptionPresenter) extends Disposable {
  ...
  private lazy val jcefHtmlPanel =
  ...
  Disposer.register(presenter, this)
  ...
  override def dispose(): Unit =
    ...
    Log.debug("DescriptionView disposed")
}
