...
object ChallengeDescriptionStyle {
  ...
  private def styleOfDojo(dojo: CodeDojo, styleProvider: WebViewStyleProvider): String =
    dojo match
  ...
  private def getLeetcodeCNStyle(styleProvider: WebViewStyleProvider): String =
    // language=CSS
    s"""
       |#container pre {
