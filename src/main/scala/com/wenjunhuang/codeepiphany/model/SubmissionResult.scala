...
object SubmissionResult {
  ...
  val SUBMISSION_SUCCESS_COLOR      = "#4CAF50"
  val SUBMISSION_FAILURE_COLOR      = "#E53935"
  val SUBMISSION_PROCESSING_COLOR   = "#2D9CDB"
  val SUBMISSION_COMPILEERROR_COLOR = "#7B1FA2"
  val SUBMISSION_TIMEOUT_COLOR      = "#FF8F00"
  val SUBMISSION_RUNTIMEERROR_COLOR = "#D81B60"
  val SUBMISSION_UNKNOWN_COLOR      = "#757575"
}
