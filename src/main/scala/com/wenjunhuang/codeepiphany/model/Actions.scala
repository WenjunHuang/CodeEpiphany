...
object Actions {
  // each code dojo in the 'CodeEpiphany Dojo toolwindow' has its query parameters toolbar
  ...
  final val HACKERRANK_TITLE_TOOLBAR_GROUP = "CodeEpiphany.Dojos.TitleToolbar.HackerRank"
  final val HACKERRANK_TITLE_TOOLBAR_PLACE = "CodeEpiphany.Dojos.TitleToolbar.HackerRank.Place"
  ...
  // submission log toolbar and popup menu
