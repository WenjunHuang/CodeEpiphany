...
public abstract class MyComboBoxAction extends AnAction implements CustomComponentAction {
    ...
    protected boolean isNoWrapping(@NotNull String place) {
        if (!NewUiValue.isEnabled()) return false;
    ...
    public class ComboBoxButton extends JButton implements UserActivityProviderComponent {
        ...
        public ComboBoxButton(@NotNull Presentation presentation) {
            ...
            putClientProperty("styleCombo", MyComboBoxAction.this);
            setMargin();
            if (isSmallVariant()) {
        ...
        private boolean isHelpTooltipEnabled() {
            return Boolean.parseBoolean(System.getProperty("ide.helptooltip.enabled", "true"));
        }

        @Override
        public @Nullable String getToolTipText() {
            return myForcePressed || isHelpTooltipEnabled() ? null : super.getToolTipText();
        }
        ...
        private void updateTooltipText() {
            ...
            if (StringUtil.isNotEmpty(myTooltipText) && isHelpTooltipEnabled()) {
                String shortcut = KeymapUtil.getFirstKeyboardShortcutText(MyComboBoxAction.this);
                new HelpTooltip().setTitle(myTooltipText).setShortcut(shortcut).installOn(this);
            } else {
                String tooltip = KeymapUtil.createTooltipText(myTooltipText, MyComboBoxAction.this);
        ...
        @Override
        public Font getFont() {
            if (myFontSet && NewUiValue.isEnabled()) return super.getFont();
        ...
        public boolean isSmallVariant() {
            return MyComboBoxAction.this.isSmallVariant();
        }
