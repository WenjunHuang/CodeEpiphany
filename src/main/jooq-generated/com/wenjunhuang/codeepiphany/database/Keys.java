...
public class Keys {
    ...
    public static final UniqueKey<HackerrankSolutionSubmissionResultRecord> HACKERRANK_SOLUTION_SUBMISSION_RESULT__PK_HACKERRANK_SOLUTION_SUBMISSION_RESULT = Internal.createUniqueKey(HackerrankSolutionSubmissionResult.HACKERRANK_SOLUTION_SUBMISSION_RESULT, DSL.name("pk_hackerrank_solution_submission_result"), new TableField[] { HackerrankSolutionSubmissionResult.HACKERRANK_SOLUTION_SUBMISSION_RESULT.ID }, true);
    ...
    public static final ForeignKey<HackerrankSolutionSubmissionResultRecord, SolutionSubmissionRecord> HACKERRANK_SOLUTION_SUBMISSION_RESULT__FK_HACKERRANK_SOLUTION_SUBMISSION_RESULT_PK_SOLUTION_SUBMISSION = Internal.createForeignKey(HackerrankSolutionSubmissionResult.HACKERRANK_SOLUTION_SUBMISSION_RESULT, DSL.name("fk_hackerrank_solution_submission_result_pk_solution_submission"), new TableField[] { HackerrankSolutionSubmissionResult.HACKERRANK_SOLUTION_SUBMISSION_RESULT.SUBMISSIONID }, Keys.SOLUTION_SUBMISSION__PK_SOLUTION_SUBMISSION, new TableField[] { SolutionSubmission.SOLUTION_SUBMISSION.ID }, true);
    ...
    public static final ForeignKey<SolutionRecord, ChallengeLanguageRecord> SOLUTION__FK_SOLUTION_PK_CHALLENGE_LANGUAGE = Internal.createForeignKey(Solution.SOLUTION, DSL.name("fk_solution_pk_challenge_language"), new TableField[] { Solution.SOLUTION.CHALLENGELANGUAGEID }, Keys.CHALLENGE_LANGUAGE__PK_CHALLENGE_LANGUAGE, new TableField[] { ChallengeLanguage.CHALLENGE_LANGUAGE.ID }, true);
